...
@Generated("")
@GraphQLName(
	description = "Represents a type of a suspicious activity.",
	value = "MessageBoardSuspiciousActivityType"
)
...
@XmlRootElement(name = "MessageBoardSuspiciousActivityType")
public class MessageBoardSuspiciousActivityType implements Serializable {

	public static MessageBoardSuspiciousActivityType toDTO(String json) {
		return ObjectMapperUtil.readValue(
			MessageBoardSuspiciousActivityType.class, json);
	}

	public static MessageBoardSuspiciousActivityType unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			MessageBoardSuspiciousActivityType.class, json);
	}

	@Schema(description = "Block of suspicious activity type.")
	@Valid
	...
	@GraphQLField(description = "Block of suspicious activity type.")
	@JsonProperty(access = JsonProperty.Access.READ_ONLY)
	protected Map<String, Map<String, String>> actions;

	@Schema(description = "Description of the suspicious activity type.")
	...
	@GraphQLField(description = "Description of the suspicious activity type.")
	...
	@Schema(
		...
		defaultValue = "com.liferay.headless.delivery.dto.v1_0.MessageBoardSuspiciousActivityType",
		name = "x-class-name"
	)
