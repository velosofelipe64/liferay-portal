...
create table MBSuspiciousActivity (
	...
	threadId LONG,
	description STRING null,
	suspiciousActivityTypeId LONG,
	validated BOOLEAN,
	primary key (suspiciousActivityId, ctCollectionId)
);

create table MBSuspiciousActivityType (
	mvccVersion LONG default 0 not null,
	ctCollectionId LONG default 0 not null,
	uuid_ VARCHAR(75) null,
	suspiciousActivityTypeId LONG not null,
	groupId LONG,
	companyId LONG,
	userId LONG,
	userName VARCHAR(75) null,
	...
	primary key (suspiciousActivityTypeId, ctCollectionId)
);
