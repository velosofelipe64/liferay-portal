...
/**
 * Provides the local service utility for MBSuspiciousActivityType. This utility wraps
 * <code>com.liferay.message.boards.service.impl.MBSuspiciousActivityTypeLocalServiceImpl</code> and
 ...
 * @generated
 */
public class MBSuspiciousActivityTypeLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.message.boards.service.impl.MBSuspiciousActivityTypeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static MBSuspiciousActivityType addMBSuspiciousActivityType(
		MBSuspiciousActivityType mbSuspiciousActivityType) {

		return getService().addMBSuspiciousActivityType(
	...
	public static MBSuspiciousActivityType addSuspiciousActivityType(
		...
		return getService().addSuspiciousActivityType(description, userId);
	}
	 ...
	 */
	public static MBSuspiciousActivityType createMBSuspiciousActivityType(
		long suspiciousActivityTypeId) {

		return getService().createMBSuspiciousActivityType(
	 ...
	 */
	public static MBSuspiciousActivityType deleteMBSuspiciousActivityType(
			long suspiciousActivityTypeId)
		throws PortalException {

		return getService().deleteMBSuspiciousActivityType(
			suspiciousActivityTypeId);
	}
	...
	public static MBSuspiciousActivityType fetchMBSuspiciousActivityType(
		long suspiciousActivityTypeId) {

		return getService().fetchMBSuspiciousActivityType(
			suspiciousActivityTypeId);
	}
	...
	public static MBSuspiciousActivityType
		...
		return getService().fetchMBSuspiciousActivityTypeByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 * @throws PortalException if a message boards suspicious activity type with the primary key could not be found
	 */
	public static MBSuspiciousActivityType getMBSuspiciousActivityType(
			long suspiciousActivityTypeId)
		throws PortalException {

		return getService().getMBSuspiciousActivityType(
			suspiciousActivityTypeId);
	}
	 ...
	 */
	public static MBSuspiciousActivityType
			getMBSuspiciousActivityTypeByUuidAndGroupId(
				String uuid, long groupId)
		throws PortalException {

		return getService().getMBSuspiciousActivityTypeByUuidAndGroupId(
			uuid, groupId);
	}
	 ...
	 */
	public static List<MBSuspiciousActivityType> getMBSuspiciousActivityTypes(
		int start, int end) {

		return getService().getMBSuspiciousActivityTypes(start, end);
	}
	 ...
	 */
	public static List<MBSuspiciousActivityType>
		getMBSuspiciousActivityTypesByUuidAndCompanyId(
			String uuid, long companyId) {

		return getService().getMBSuspiciousActivityTypesByUuidAndCompanyId(
			uuid, companyId);
	}
	 ...
	 */
	public static int getMBSuspiciousActivityTypesCount() {
		return getService().getMBSuspiciousActivityTypesCount();
	}
	 ...
	 */
	public static MBSuspiciousActivityType updateMBSuspiciousActivityType(
		MBSuspiciousActivityType mbSuspiciousActivityType) {

		return getService().updateMBSuspiciousActivityType(
			mbSuspiciousActivityType);
	}
	...
	public static MBSuspiciousActivityTypeLocalService getService() {
		return _service;
	}

	private static volatile MBSuspiciousActivityTypeLocalService _service;
